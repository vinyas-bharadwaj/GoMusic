...
export default function Login() {
  ...
  return (
    <div className="relative flex min-h-screen overflow-hidden">
      {/* Left side - Form */}
      <div className="relative z-10 w-full max-w-md m-auto p-8">
        <div className="bg-gray-900 shadow-xl rounded-lg p-8 border border-gray-800 bg-opacity-90">
          ...
          <form onSubmit={loginUser}>
            ...
            <div className="text-center text-gray-400">
              <p>Don't have an account? <Link href="/signup" className="text-pink-400 hover:text-pink-300 transition-colors">Sign up</Link></p>
            </div>
          </form>
        </div>
      </div>
      ...
      <div className="hidden lg:flex w-1/2 items-center justify-center relative z-10">
        <div className="relative z-10 text-center px-12">
          ...
          <p className="text-xl text-gray-300">Access your favorite tracks, playlists, and discover new music.</p>
        </div>
      </div>
    </div>
  );
